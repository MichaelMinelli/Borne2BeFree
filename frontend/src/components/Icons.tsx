...
export const InformationOldSolidIcon = InformationSvgContainer(<path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" />);

export const InformationSolidIcon = ({ classes }: IconProps) => <svg aria-hidden="true" role="status" className={ classes + 'inline w-4 h-4 me-3 text-white animate-spin' } viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const LogoutSolidIcon = ({ classes }: IconProps) => <svg fill="none" className={ classes } height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
export const PasswordIcon = ({ classes }: IconProps) => <svg className={ classes } height="24" viewBox="0 0 24 24" width="24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8 16H8.009M11.991 16H12M15.991 16H16" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
</svg>;